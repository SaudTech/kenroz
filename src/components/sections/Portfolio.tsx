        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Success{' '}
              <span className="bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">Stories</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
            {projects.map((project, index) => (
              <div key={index} className="transform transition-all duration-300 hover:scale-105">
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl hover:border-primary-200 transition-all duration-300 group overflow-hidden bg-white h-full">
                  <div className="p-6">
                    <div className="flex items-center mb-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-secondary-600 rounded-xl flex items-center justify-center mr-3 border border-primary-300 hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="mb-3">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {project.technologies.map((tech, techIndex) => (
                          <Badge key={techIndex} className="bg-primary-100 text-primary-600 hover:bg-primary-200 transition-colors duration-200 text-xs border border-primary-200">
                            {tech}
                          </Badge>
                        ))}
                      </div>
