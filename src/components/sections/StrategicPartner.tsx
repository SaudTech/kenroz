...
const partners: Partner[] = [
  ...
  },
  {
    ...
    logo: "/logo_full.png",
    description:
      "Our mission is to help businesses leverage technology to achieve their goals and drive growth.",
    website: "https://arcgen.in",
    tags: ["Speech Recognition", "Healthcare"],
  },
];
    ...
    <section className="w-full" id="strategic-partners">
      <div className="relative z-[4] mx-auto max-w-7xl px-4 py-16 md:py-24">
        ...
        <div className="mt-10 grid grid-cols-1 gap-8">
          ...
          <div className="order-2 h-[400px] md:order-1 grid grid-cols-1 sm:grid-cols-3 gap-6 pt-2 items-stretch">
            {partners.map((p, i) => (
          ...
          <div className="order-1 md:order-2 text-center md:pl-4">
            <div className="md:sticky md:top-28 text-center md:text-left">
              ...
              <ul className="mt-6 -space-y-4 list-disc list-inside text-center w-full flex gap-2 justify-center">
                {[
