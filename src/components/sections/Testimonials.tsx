      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <span className="bg-primary-100 text-primary-600 px-4 py-2 text-sm font-semibold rounded-full border border-primary-200">Testimonials</span>
            <h2 className="text-3xl font-bold text-gray-900 mt-4 mb-4">
              What Our{' '}
              <span className="bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">Clients Say</span>
            </h2>
