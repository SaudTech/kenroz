  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-secondary-600/20 rounded-full blur-3xl animate-pulse" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <a
              href="#contact"
              className="bg-gradient-to-r flex items-center from-primary-600 to-secondary-600 hover:from-primary-700 hover:to-secondary-700 text-white px-8 py-4 text-lg font-semibold rounded-lg shadow-2xl hover:shadow-primary-500/25 transition-all duration-300 group border border-primary-500/30 hover:scale-105"
              onClick={(e) => {
                e.preventDefault()
            ...
            <a
              href="#portfolio"
              className="border-2 border-gray-600 hover:border-primary-500 text-gray-300 hover:text-white px-8 py-4 text-lg font-semibold rounded-lg transition-all duration-300 hover:bg-primary-600/10 hover:scale-105"
              onClick={(e) => {
                e.preventDefault()
