...
export default function Contact() {
  const contacts = [
    ...
    { icon: Mail, title: 'Email', value: 'hello@techflow.com', subtitle: 'We respond within 24 hours' },
              ...
              <div key={index} className="transform transition-all duration-300 hover:scale-105">
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl hover:border-blue-200 transition-all duration-300 bg-white h-full">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-blue-600 text-base font-semibold mb-2">{contact.value}</p>
