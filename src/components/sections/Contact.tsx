        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Let&apos;s Build{' '}
              <span className="bg-gradient-to-r from-[#7e141c] to-[#e31b25] bg-clip-text text-transparent">Together</span>
            </h2>
              ...
              <div key={index} className="transform transition-all duration-300 hover:scale-105">
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl hover:border-yellow-200 transition-all duration-300 bg-white h-full">
                  <CardContent className="p-8 text-center">
                    <div className="w-12 h-12 bg-gradient-to-br from-yellow-100 to-white rounded-xl flex items-center justify-center mx-auto mb-4 border border-yellow-200 hover:scale-110 transition-transform duration-300">
                      <contact.icon className="w-6 h-6 text-[#e31b25]" />
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 mb-2">{contact.title}</h3>
                    <p className="text-[#e31b25] text-base font-semibold mb-2">{contact.value}</p>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              <a
                href="#"
                className="p-3 bg-gradient-to-r from-[#7e141c] to-[#e31b25] text-white rounded-xl hover:shadow-lg transition-all duration-300 group border border-[#7e141c] hover:scale-110"
