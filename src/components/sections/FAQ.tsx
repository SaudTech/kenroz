      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <span className="bg-primary-100 text-primary-600 px-4 py-2 text-sm font-semibold rounded-full border border-primary-200">FAQ</span>
          ...
          <div className="text-center mt-8">
            ...
            <a
              href="#contact"
              className="bg-gradient-to-r from-primary-600 to-secondary-600 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 inline-block hover:scale-105"
              onClick={(e) => {
                e.preventDefault()
