...
import { Instagram, Facebook, Twitter, Linkedin, MapPin, ExternalLink, Mail } from "lucide-react";
...
function LocationCard({ city, flag, location, email }: (typeof locations)[number]) {
  ...
  return (
    <div className="group relative bg-white/5 backdrop-blur-sm rounded-lg border border-white/10 p-4 hover:bg-white/10 transition-all duration-300 hover:shadow-lg hover:border-white/20">
      ...
      <div className="mb-3">
        <a
          ...
          className="flex items-start gap-2 text-sm text-white/70 hover:text-white transition-colors group/link"
      ...
      <a
        href={mail}
        className="flex items-center gap-2 text-sm text-white/70 hover:text-white transition-colors group/phone"
...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black text-white border-t border-white/10 relative z-[90]" aria-label="Site footer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <h4 className="text-lg font-semibold text-white mb-6 relative">
                Services
                <div className="absolute -bottom-2 left-0 w-8 h-0.5 bg-gradient-to-r from-blue-500 to-purple-600"></div>
              </h4>
            ...
            <div className="lg:col-span-2">
              <h4 className="text-lg font-semibold text-white mb-6 relative">
                Products
                <div className="absolute -bottom-2 left-0 w-8 h-0.5 bg-gradient-to-r from-green-500 to-teal-600"></div>
              </h4>
              <ul className="space-y-3">
            ...
            <div className="lg:col-span-2">
              <h4 className="text-lg font-semibold text-white mb-6 relative">
                Resources
                <div className="absolute -bottom-2 left-0 w-8 h-0.5 bg-gradient-to-r from-orange-500 to-red-600"></div>
              </h4>
              <ul className="space-y-3">
            ...
            <div className="lg:col-span-2">
              <h4 className="text-lg font-semibold text-white mb-6 relative">
                Connect
                <div className="absolute -bottom-2 left-0 w-8 h-0.5 bg-gradient-to-r from-pink-500 to-violet-600"></div>
              </h4>
              <div className="space-y-3">
                {socials.map((social) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 text-white/70 hover:text-white text-sm transition-all duration-200 hover:translate-x-1 group"
                  >
