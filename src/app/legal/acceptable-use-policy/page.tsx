  ...
  return (
    ...
    >
      ...
      <nav
        ...
        className="mb-8 rounded-xl border bg-card/60 backdrop-blur-sm p-4"
      >
      ...
      <section id="scope" className="space-y-4 mb-8">
        ...
        <p>
          ...
          not agree, you must not use the Services. We may update this AUP from
          time to time; changes will be posted on this page.
        </p>
      </section>
      ...
      <section id="definitions" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            <strong>Malicious Code:</strong> Viruses, worms, time bombs, Trojan
            horses, ransomware, spyware, or other code intended to disrupt,
          ...
          <li>
            <strong>Resource Abuse:</strong> Use that degrades the Services for
            others, including excessive API calls, CPU/RAM/disk usage, or
      ...
      <section id="responsibilities" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            Ensure all Customer Content is lawful, accurate where required, and
            properly licensed.
          </li>
        </ul>
      </section>
      ...
      <section id="prohibited" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            <strong>Illegal activity:</strong> Engage in, promote, or facilitate
            unlawful acts, including fraud, money laundering, human trafficking,
            distribution of illegal substances, or violation of export
            controls/sanctions.
          </li>
          <li>
            <strong>Security violations:</strong> Attempt unauthorized access,
            probe/scan/penetration testing of networks without consent, exploit
            vulnerabilities, or bypass authentication/authorization.
          </li>
          <li>
            <strong>Network abuse:</strong> DDoS, reflection/amplification
            attacks, traffic flooding, port scanning, or packet crafting causing
            network degradation.
          </li>
          <li>
            <strong>Malware:</strong> Distribute Malicious Code, crypto-jacking,
            botnets, droppers, or command-and-control infrastructure.
          </li>
          <li>
            <strong>Spam & deceptive practices:</strong> Send unsolicited bulk
            messages, snowshoeing, list harvesting, sending without consent, or
            misleading headers/subject lines.
          </li>
          <li>
            <strong>Harassment & harm:</strong> Bully, harass, threaten violence
            or property damage; incite or celebrate harm; stalk or dox
            individuals.
          </li>
          <li>
            <strong>Child sexual exploitation (CSE) & abuse material:</strong>{" "}
            Strictly prohibited; will be reported to authorities where required.
          </li>
          <li>
          ...
          <li>
            ...
            data or restricted areas, or circumvent robots.txt, rate limits, or
            access controls.
          </li>
          <li>
          ...
          <li>
            ...
            safety-critical systems without appropriate redundancies and written
            authorization.
          </li>
          <li>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          logged-in dashboards, sending bulk emails to purchased lists, phishing
          pages, or operating exit nodes/relays that obscure origins for abuse.
        </p>
      </section>
      ...
      <section id="security" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            Do not share API keys publicly or embed secrets in client-side code;
            use server-side storage and environment variables.
          </li>
          <li>
            Immediately notify us of suspected breaches, credential exposure, or
      ...
      <section id="integrity" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            Do not attempt to disable or degrade protective controls (firewalls,
      ...
      <section id="api" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            <strong>Caching:</strong> Use reasonable caching to avoid excessive
            polling; avoid hot-loop retries.
          </li>
          <li>
      ...
      <section id="messaging" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            Honor opt-outs promptly; do not re-subscribe users without explicit
            renewed consent.
          </li>
          <li>
      ...
      <section id="content" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            Be unlawful, defamatory, libelous, invasive of privacy, or otherwise
            objectionable.
          </li>
          <li>
          ...
          <li>
            Include sensitive personal data without lawful basis and safeguards
            (e.g., health, biometric, financial identifiers).
          </li>
        </ul>
      </section>
      ...
      <section id="ip" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            Do not remove, obscure, or alter proprietary notices or branding on
            the Services.
          </li>
          <li>
            Provide proper attribution where required by licenses or third-party
            terms.
          </li>
        </ul>
      </section>
      ...
      <section id="privacy" className="space-y-4 mb-8">
        <h2 className="text-xl font-semibold">11. Privacy & Data Protection</h2>
        <p>
      ...
      <section id="thirdparty" className="space-y-4 mb-8">
        ...
        <p>
          If you enable third-party integrations, you are responsible for their
          configuration and for complying with their terms. We are not
          responsible for third-party products or services.
        </p>
      </section>

      <section id="monitoring" className="space-y-4 mb-8">
        <h2 className="text-xl font-semibold">13. Monitoring & Enforcement</h2>
        <ul className="list-disc pl-5 space-y-2">
          <li>
      ...
      <section id="consequences" className="space-y-4 mb-8">
        <h2 className="text-xl font-semibold">14. Violations & Consequences</h2>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            Removal of offending content, quarantine of resources, or isolation
        ...
        <p className="text-sm text-muted-foreground">
          ...
          incurred. Some violations may trigger fees for remediation, recovery,
          or third-party costs (e.g., abuse desk handling, blacklist delisting).
        </p>
      </section>
      ...
      <section id="lawenforcement" className="space-y-4 mb-8">
        <h2 className="text-xl font-semibold">16. Law Enforcement Requests</h2>
        <p>
      ...
      <section id="changes" className="space-y-4 mb-8">
        ...
        <p>
          ...
          page with a revised “Last updated” date. Material changes may also be
          communicated by email or in-app notices where required.
        </p>
      </section>
