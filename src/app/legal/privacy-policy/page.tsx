  ...
  return (
    ...
    >
      ...
      <section id="introduction" className="space-y-4 mb-8">
        ...
        <p>
          Kenroz (“<strong>we</strong>”, “<strong>us</strong>”, or “<strong>our</strong>”) values your privacy. This Privacy Policy explains how we
          collect, use, store, and share information when you use our websites, applications, and services (collectively, the “<strong>Services</strong>”).
      ...
      <section id="collection" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            <strong>Personal information you provide:</strong> such as your name, email, phone, billing info, or
            account details when signing up, contacting support, or making a purchase.
          </li>
          <li>
            <strong>Usage data:</strong> including IP address, device info, browser type, pages visited, actions
            taken, and time spent.
          </li>
          <li>
            <strong>Cookies and similar technologies:</strong> to remember preferences, measure engagement, and
            improve performance.
          </li>
        </ul>
      </section>
      ...
      <section id="legal-bases" className="space-y-4 mb-8">
        ...
        <p>We process personal data under the following bases (where applicable):</p>
        <ul className="list-disc pl-5 space-y-2">
      ...
      <section id="sharing" className="space-y-4 mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>Trusted vendors, partners, and service providers who support our operations.</li>
          <li>Authorities, regulators, or law enforcement if required by law or to protect rights and safety.</li>
          <li>
            In case of merger, acquisition, or asset sale, your information may be transferred as part of the
      ...
      <section id="cookies" className="space-y-4 mb-8">
        ...
        <p>
          We use cookies, pixels, and similar tools to enable essential functions, analyze usage, and improve user
          experience. You can manage cookie preferences in your browser settings. Some features may not function properly
          without cookies.
        </p>
      </section>
      ...
      <section id="retention" className="space-y-4 mb-8">
        ...
        <p>
          We retain personal data as long as necessary to fulfill the purposes outlined in this Policy, unless a longer
          retention period is required by law. When no longer needed, we securely delete or anonymize data.
        </p>
      </section>
      ...
      <section id="transfers" className="space-y-4 mb-8">
        ...
        <p>
          As a global service provider, we may process and store information outside your country of residence. We
          implement safeguards (e.g., standard contractual clauses) to ensure your data receives adequate protection.
        </p>
      </section>
      ...
      <section id="security" className="space-y-4 mb-8">
        ...
        <p>
          ...
          alteration, disclosure, or destruction. However, no system is completely secure, and we cannot guarantee
          absolute protection.
        </p>
      </section>
      ...
      <section id="children" className="space-y-4 mb-8">
        ...
        <p>
          Our Services are not directed to individuals under the age of 16 (or the applicable age of digital consent in
          your jurisdiction). We do not knowingly collect personal data from children. If we learn we have collected data
          from a child, we will delete it promptly.
        </p>
      </section>

      <section id="third-party" className="space-y-4 mb-8">
        <h2 className="text-xl font-semibold">12. Third-Party Links & Services</h2>
        <p>
          The Services may contain links to or integrate with third-party websites, apps, or services. We are not
          responsible for the privacy practices of third parties. We encourage you to review their policies.
        </p>
      </section>
      ...
      <section id="changes" className="space-y-4 mb-8">
        ...
        <p>
          ...
          Material changes may also be communicated by email or in-app notification, where required by law.
        </p>
      </section>
