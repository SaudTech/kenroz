      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            >
              <motion.div
                className="inline-flex items-center justify-center rounded-2xl text-2xl font-bold mb-6"
                whileHover={{ scale: 1.05, rotate: 5 }}
                transition={{ duration: 0.3 }}
              >
                <div className="bg-white/10 backdrop-blur-lg border border-white/20 px-6 py-3 rounded-2xl shadow-2xl">
                  <Image
                    src="/logo.png"
                    alt="Kenroz Logo"
                    width={150}
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-purple-400 font-bold mb-4">Take a lead, get Notified!</p>
              <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Transforming ambitious ideas into powerful digital realities. From concept to deployment, we deliver
            ...
            >
              <motion.a
                href="#contact"
                className="bg-gradient-to-r flex items-center from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-4 text-lg font-semibold rounded-lg shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 group border border-purple-500/30"
              ...
              <motion.a
                href="#portfolio"
                className="border-2 border-gray-600 hover:border-purple-500 text-gray-300 hover:text-white px-8 py-4 text-lg font-semibold rounded-lg transition-all duration-300 hover:bg-purple-600/10"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                View Our Work
              ...
              >
                <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 shadow-lg border border-purple-100/50">
                  ...
                  <p className="text-base text-gray-700 leading-relaxed mb-4">
                    We are Kenroz, a dynamic technology company based in India, dedicated to transforming businesses
                    through innovative digital solutions. We specialize in developing fully functioning applications
                    including cutting-edge websites and mobile apps.
                  </p>
                  <p className="text-base text-gray-700 leading-relaxed">
                    Our comprehensive services span from initial app development to ongoing management of websites and
                    mobile applications. We also excel in social media management, guaranteeing increased customer
          ...
          <div className="max-w-6xl mx-auto">
              ...
              {[
                {
                  ...
                  description:
                    "Robust, scalable database solutions designed for optimal performance and security. We architect data systems that grow with your business.",
                },
                {
                  icon: Smartphone,
                  title: "Mobile App Development",
                  description:
                    "Native and cross-platform mobile applications with complete App Store & Play Store deployment following all guidelines and best practices.",
                },
                {
                  icon: Settings,
                  title: "Software Management",
                  description:
                    "Comprehensive management and optimization of existing software systems. We ensure your applications run smoothly and efficiently.",
                },
                {
                  icon: Code,
                  title: "Web Development",
                  description:
                    "Full-stack development of modern web applications using cutting-edge technologies and frameworks for optimal performance.",
                },
              ].map((service, index) => (
                <motion.div
                  key={index}
            ...
            >
              <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-10 text-white shadow-2xl border border-purple-500/20">
                ...
                <motion.a
                  href="#contact"
                  className="bg-white text-purple-600 hover:bg-gray-100 px-8 py-3 font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 inline-block"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Start Your Project
              ...
              {[
                {
                  ...
                  description:
                    "ZATCA-compliant e-invoicing SaaS platform that significantly reduced invoice rejections and streamlined tax approval workflows for Saudi businesses.",
                ...
                },
                {
                  ...
                  description:
                    "Patient-doctor portal with real-time video conferencing via Twilio, data visualization using ReCharts, and automated SMS reminders.",
                ...
                },
                {
                  ...
                  description:
                    "Healthcare web application with Azure AI integration, automated speech recognition, and Firebase-based real-time chat for enhanced doctor-patient communication.",
                ...
                },
                {
                  ...
                  description:
                    "Comprehensive drag-and-drop form builder with 15+ reusable components, reducing development time by 80% and eliminating manual form coding.",
                      ...
                      <div className="mb-3">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {project.technologies.map((tech, techIndex) => (
                            <Badge
                              key={techIndex}
                              className="bg-purple-100 text-purple-600 hover:bg-purple-200 transition-colors duration-200 text-xs border border-purple-200"
                            >
                              {tech}
                            </Badge>
                          ))}
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center mb-4">
                ...
                />
                <span className="font-bold text-lg text-white">Kenroz</span>
              </div>
              <p className="text-gray-300 mb-6 max-w-md leading-relaxed text-sm">
                Building the future of software development and management. We transform ideas into powerful digital
                solutions that drive business growth.
              </p>
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  <Phone className="w-4 h-4 text-purple-400" />
                  <span className="text-gray-300 text-sm">+91 770-273-5203</span>
                </div>
                <div className="flex items-center space-x-3">
